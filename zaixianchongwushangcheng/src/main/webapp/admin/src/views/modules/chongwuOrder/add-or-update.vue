    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='chongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="省" prop="chongwuValue">
                        <el-input v-model="chongwuForm.chongwuValue"
                                  placeholder="省" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约流水号" prop="chongwuOrderUuidNumber">
                       <el-input v-model="ruleForm.chongwuOrderUuidNumber"
                                 placeholder="预约流水号" clearable  :readonly="ro.chongwuOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="预约流水号" prop="chongwuOrderUuidNumber">
                           <el-input v-model="ruleForm.chongwuOrderUuidNumber"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    insertTime: false,
                    chongwuOrderYesnoTypes: false,
                    chongwuOrderYesnoText: false,
                    updateTime: false,
                },
                ruleForm: {
                    ...
                    yonghuId: '',
                    insertTime: '',
                    chongwuOrderYesnoTypes: '',
                    chongwuOrderYesnoText: '',
                    updateTime: '',
                },
                chongwuOrderYesnoTypesOptions : [],
                chongwuOptions : [],
                yonghuOptions : [],
                rules: {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chongwu_order_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chongwuOrderYesnoTypesOptions = data.data.list;
                    }
                });

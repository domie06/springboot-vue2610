            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12" v-if="ruleForm.shangpinTypes != null && ruleForm.shangpinTypes != ''">
                    <el-form-item class="select" v-if="type!='info'"  label="二级分类" prop="shangpinErjiTypes">
                        <el-select v-model="ruleForm.shangpinErjiTypes" :disabled="ro.shangpinErjiTypes" placeholder="请选择二级分类">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="二级分类" prop="shangpinErjiValue">

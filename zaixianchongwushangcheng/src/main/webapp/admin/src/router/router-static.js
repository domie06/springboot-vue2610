...
import center from '@/views/center'
    ...
    import dictionaryChongwuErji from '@/views/modules/dictionaryChongwuErji/list'
        import dictionaryChongwuErjiAddOrUpdate from '@/views/modules/dictionaryChongwuErji/add-or-update'//二级
    import dictionaryChongwuLeixing from '@/views/modules/dictionaryChongwuLeixing/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryChongwuErji',
        name: '市',
        component: dictionaryChongwuErji
    }
    ,{
        path: '/dictionaryChongwuErjiAddOrUpdate',
        name: '市的新增修改页面',
        component: dictionaryChongwuErjiAddOrUpdate
    }
    ,{
        path: '/dictionaryChongwuLeixing',
        name: '宠物类型',
        component: dictionaryChongwuLeixing
    }
    ,{
